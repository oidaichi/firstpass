...
export const content = {
  ...
  // ----------------------------------------------------------
  demo: {
    heading: "ハヤパスのデモを体験してみましょう！",
    popup: {
      description1: [
        "ハヤパスASPでは、誰でも簡単に条件入力するだけで、提案時に必要な太陽光・蓄",
        "電池導入効果の算出が可能です。",
      ],
      description2: [
        "こちらのデモ版では「既築20年で太陽光と蓄電池の2点を新設する場合」のシミュレー",
        "ションを作成します。",
      ],
      description3: "実際にデモ画面を触って体験してみましょう！",
      simulationExample: {
        title: "蓄電池の経済効果シミュレーション実例",
        description: [
          "お客様情報と提案内容を入力したら、たった15秒で診断結果と提案書が自動作成されます。", "出力されるデータはエクセルとPDFの２種類、電気代上昇率を加味した長期経済効果、実質支払い額", "（毎月、1日当たり）導入施設毎の効果額など詳細なデータを出力いたします。",
        ],
      },
    },
  },
  ...
  about: {
    sectionTitle: "ハヤパスとは？",
    subTitle: ["行列は、店の実力の証明です。", "でも、並んでいる時間は双方にとって損失でもあります。"],
    description: [
      "ハヤパスは、QRコードを1枚置くだけで、",
      "その行列を収益に変える完全成果報酬型のサービスです。",
      "アプリ不要。月額費用ゼロ。初期費用ゼロ。",
      "売れた金額の25%だけいただきます。",
    ],
    description2: ["飲食店・整骨院・クリニック・カフェ・スイーツ店など", "あらゆる業種の「待ち時間」を価値に変えます。"],
    steps: [
      {
        number: "01",
        title: "QRコードを店頭に置く",
  ...
  painPoints: {
    ...
    cards: [
      "行列のせいで、逆に売上機会を失っている",
      "お客様を待たせすぎて、クレームや低評価につながっている",
      "新しいシステムは、覚えるのが大変そうで導入したくない",
    ],
  },
  ...
  features: {
    ...
    cards: [
      ...
      {
        number: "02", // For "3つの特長" section
        title: "離脱客の防止",
        titlePrefix: "来店機会UP",
        description: [
          "「並ぶのを諦めた」お客様をファストパスで取り戻す。",
          "来店機会の損失を最小化。",
        ],
      },
      {
      ...
      {
        number: "02", // Placeholder for DivTitle29
        title: "顧客満足度の向上",
        description: [
          "「待つ」ストレスから解放され、",
          "お客様の満足度が向上。",
          "クレームが減り、高評価レビューも期待できます。",
        ],
      },
      {
        number: "03", // For "3つの特長" section (copy for index safety)
        title: "設置・運用がかんたん",
        titlePrefix: "即日スタート",
        description: [
          "申し込み3分、QRが届いたら",
      ...
      {
        number: "03", // Placeholder for DivTitle30
        title: "かんたん導入・負担ゼロ",
        description: [
          "QRコードを置くだけで、",
          "スタッフの研修や手間は一切不要。",
  ...
  industry: {
    title: "ハヤパス活用効果",
    description1: "実際にハヤパスASPを導入し、成果をあげた企業さまの活用方法の一例をご紹介します。",
    description2: "月15件提案の場合…年384万円（約70%削減）のコスト削減。",
    description3: "さらに提案スピードUPで受注率アップに貢献。",
    description4: "月2〜3件の太陽光、蓄電池の受注粗利により投資回収可。",
  ...
  support: {
    ...
    otherConsultations: {
      title: "他にもこんなご相談にも対応いたします。",
      items: [
        "ファストパスの最適な価格設定について相談したい", "複数店舗での導入や、売上の一括管理について知りたい", "インバウンド向けの案内や多言語対応について相談したい", "季節やイベントに合わせた限定ファストパスの企画をしたい", "POSレジや既存の予約システムとの連携について相談したい", "ハヤパスAPIを利用して独自の機能を開発したい", "売上データを活用した経営分析のサポートをしてほしい", "SNSでの告知やプロモーション方法について相談したい", "メディア取材やプレスリリースについて相談したい", "オリジナルデザインのQRコードパネルを作成したい", "導入後の効果測定や改善提案をしてほしい", "スタッフ向けの簡単なオペレーションマニュアルがほしい",
      ],
    },
    description1: [
  ...
  serviceLineup: {
    ...
    sectionTitle2: "料金プラン",
    description2: ["初期費用・月額費用はすべて無料。", "ファストパスが売れた金額の25%のみいただきます。売れなければ、完全無料。"],
    viewMoreButton: "料金について詳しく見る",
    popularPlanLabel: "人気の定番プラン！",
    estimateLabel: "個別見積",
    description: [
    ...
    plans: [
      {
        ...
        price: "150,000",
        priceUnit: "円/月",
        recommendedFor: "工務店・販売店・商社",
        features: [
          "最大5名まで（管理者機能なし）", "保存世帯数無制限",
        ],
        support: ["チャットサポート", "オンラインFAQ/マニュアル", "WEB勉強会"],
      },
      {
        name: "ハヤパス マルチ",
        ...
        price: "300,000",
        priceUnit: "円/月",
        recommendedFor: "Excelデータ提供有り",
        features: [
          "最大30名まで（管理者機能あり）", "保存世帯数無制限",
        ],
        support: ["チャットサポート", "オンラインFAQ/マニュアル", "WEB勉強会"],
        isPopular: true,
      },
      {
        ...
        price: "600,000",
        priceUnit: "円/月",
        recommendedFor: "大手販社・商社・住宅会社",
        features: [
          "ユーザー数無制限（管理者機能あり）", "保存世帯数無制限",
        ],
        support: ["チャットサポート", "オンラインFAQ/マニュアル", "WEB勉強会"],
      },
      {
        ...
        price: null, // "個別見積"
        priceUnit: "円/月",
        recommendedFor: "大手メーカー・商社・卸や電力・ガス会社",
        features: [
          "ユーザー数無制限（管理者機能あり）", "保存世帯数無制限",
        ],
        support: ["チャットサポート", "オンラインFAQ/マニュアル", "WEB勉強会"],
  ...
  faq: {
    ...
    questions: [
      ...
      {
        q: "経済効果シミュレーションを保証してくれるんですか？", a: "",
      }, {
        q: "産業用自家消費型太陽光や産業用蓄電池にも対応していますか？", a: "",
      }, {
        q: "EVやEV充電器、V2H、トライブリッドのシミュレーションはできるか？", a: "",
      },
      {
      ...
      },
      {
        ...
        q: "ハヤパスASPに登録されている蓄電池はどれくらいありますか?", a: "",
      }, {
        q: "ペロブスカイト等の壁面太陽光発電量シミュレーションは可能ですか？", a: "",
      },
    ],
  },
  ...
  announcements: {
    ...
    items: [
      ...
      },
      {
        date: "2024-04-26",
        content: [
          "いつもハヤパスをご利用いただき誠にありがとうございます。",
          "GW（ゴールデンウィーク）の弊社営業日およびチャットサポートにつきまして、下記のとおりご案内いたします。",
          "休業期間：2024/4/27（土）～5/6（月）の10日間",
          "（上記の期間はチャットサポートをお休みいただきます）",
          "　・GW休暇期間にいただいたお問い合わせは、2024/5/6（月）より順次回答させていただきます。ご不便をおかけいたしますが、",
          "ご理解のほどよろしくお願いいたします。",
          "　・休業期間は大変恐縮ですが、オンラインマニュアルおよびFAQをご活用くださいませ。",
          "　・それでは皆様よいGWを！",
        ],
      },
      {
      ...
      },
      {
        date: "2024-04-17",
        content: [
          "「スマエネ補助金2024年度版」のデータを反映致しました。「共通管理画面」（右上のビルアイコン）＞「データ照会」＞「補助金",
          "DB照会」よりご確認頂けます。",
        ],
      },
      {
        date: "2024-02-26",
        content: [
          "「蓄電池を使用したらなぜ電力使用量が増えるのか」というお問い合わせがあまりにも多いため、「待機電力を考慮しない」をデフ",
          "ォルトの設定に変更しました。従来どおり待機電力を考慮したシミュレーションを行いたい場合は、個人設定の蓄電池設定でデフォ",
          "ルトを変更するか、詳細診断の蓄電池設定で変更してください。よろしくお願いいたします。",
        ],
      },
      {
        date: "2024-02-19",
        content: [
          "ハヤパスASPを v4.2にリリースアップしました（内部的なアップデートで機能自体に大きな変更はありません）。引き続きよろ",
          "しくお願いいたします。",
        ],
      },
      {
        date: "2023-12-08",
        content: [
          "年末年始のサポート営業日のご案内（休業期間：2023/12/28〜2024/1/4） いつもハヤパスをご利用いただきありがとうございま",
          "す。 年末年始のチャットサポートについてお知らせいたします。 誠に勝手ながら、以下の期間において、有人によるチャットサポ",
          "ートをお休みさせていただきます。 ・年内の対応 2023年12月27日（水）17時まで ・年始の対応 2024年1月5日（金）10時から順次",
          "対応 休業期間中にいただいたお問い合わせにつきましては、2024年1月5日（金）10時より順次対応させていただきます。 ご不便を",
          "お掛けいたしますが、何卒よろしくお願いいたします。 2023年中はハヤパスをご愛顧いただき、誠にありがとうございました。",
          "2024年もどうぞよろしくお願い申し上げます。 ハヤパス運営事務局",
        ],
      },
      {
        date: "2023-11-30",
        content: [
          "以下の蓄電池が新たに診断可能になりました。",
          "【長州産業】スマートPVマルチ 単機能(6.3kWh)",
          "【長州産業】スマートPVマルチ ハイブリット(6.3kWh) 表示されない場合は各企業の担当者様で制限されている可能性がございます",
          "ので、そちらにご確認お願いいたします。",
        ],
      },
      {
        ...
        content: [
          "以下の蓄電池が新たに診断可能になりました。",
          "【長州産業】スマートPVマルチ 単機能(12.7kWh)",
          "【長州産業】スマートPVマルチ ハイブリット(12.7kWh)",
          "【トヨタ自動車】おうち給電システム(8.7kWh)",
        ],
      },
      {
        date: "2023-06-26",
        content: [
          "ASP/EVとBIZのユーザー管理・グループ管理を統合しました。同時に、プランによる保存世帯数・診断結果数の上限を廃止しまし",
          "た。",
        ],
      },
    ],
  ...
  cta: {
    ...
    subTitle: "たった15秒でシミュレーション完了",
    title: ["むずかしいシミュレーションを", "誰でもカンタンに。"],
    description2: [
      "国内家庭用太陽光・蓄電池販売ランキングNo.1・No.2もハヤパスを採用。", "最新バージョン・全機能が今すぐ30日間無料でお試しいただけます。", "全国各地の大手から中小までゾクゾク活用中。", "今すぐ無料で試しませんか？",
    ],
    trialButton2: "無料で30日全機能を試してみる",
  ...
  // ----------------------------------------------------------
  footer: {
    copyright2: "Copyright ©国際航業株式会社 All Rights Reserved.",
